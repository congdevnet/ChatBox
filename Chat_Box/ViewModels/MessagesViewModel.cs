namespace DXHtmlMessengerSample.ViewModels {
    ...
    public class MessagesViewModel : ChannelViewModel {
        ...
        public virtual IReadOnlyCollection<Message> MessageDtos
        {
            get;set;
        }
       ...
       // MessageDto lastMessage;
        ...
        public void SendMessage() {
            ...
            if (Channel != null)
            {
                Message message = new Message(Contact, MessageText, DateTime.Now);
                Messgers.Messages.Add(message);
            }
            MessageText = null;
            OnChannelReady();
        }
